...
iMultiIntegerList[n_?((IntegerQ[#]&&#>=0&)||#==Infinity||#==-Infinity&),list:{__?(IntegerQ[#]&&#>1&)},opts:OptionsPattern[]]:=Module[{
	(* Functions *)
...
(* ::Text:: *)
(*instead. I already have a fix written for this. Whenever I implement it, I'll be sure to edit info in "Options", D&O, and any other places.*)


(* ::ItemNumbered:: *)
(*Design changes may be implemented to change the behavior discussed in "Possible Issues". Perhaps these scenarios should be handled the same?*)
