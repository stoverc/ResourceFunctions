...
(* ::Code::Initialization::"Tags"-><|"UppercaseVariable" -> <|Enabled -> False|>|>:: *)
...
(* ::Subitem:: *)
(*Determine the largest integers Subscript[\[Alpha], 1],\[Ellipsis],Subscript[\[Alpha], k] for which Subscript[p, 1]^Subscript[\[Alpha], 1],\[Ellipsis],Subscript[p, k]^Subscript[\[Alpha], k] all divide n.*)


(* ::Subitem:: *)
(*Compute Subscript[m, 1]=Max[Subscript[p, 1]^Subscript[\[Alpha], 1],\[Ellipsis],Subscript[p, k]^Subscript[\[Alpha], k]]. Subscript[m, 1] is the first term of the factorization of n.*)


(* ::Subitem:: *)
(*Repeat the the process for Subscript[n, 1]=n-Subscript[m, 1] to find the second term of the factorization.*)


(* ::Subitem:: *)
(*Continue iterating until the resulting integer Subscript[n, \[Beta]] either equals 0 or 1.*)
