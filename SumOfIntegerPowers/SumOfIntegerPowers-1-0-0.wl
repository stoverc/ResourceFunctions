...
(* ::Text:: *)
(*Perhaps these scenarios should be handled the same? Or perhaps the first situation should be handled differently if "HoldListProducts" and "Collect" are both set to \!\( *)
(*TagBox[*)
(*ButtonBox[*)
